...
let joinRegexMessages = ["", "공백 제외 영어 및 숫자, 특수문자 모두 포함하여 10~20자로 입력해주세요.", "위 비밀번호와 일치하지 않습니다. 다시 입력해주세요.", "이메일 주소를 확인해주세요."];
...
$joinInputs.on("blur", function(){
    ...
    switch(i){
        case 0:
            joinCheck = value.length > 3 && value.length < 21 && !specialCharacterRegex.test(value);
            break;
        case 1:
