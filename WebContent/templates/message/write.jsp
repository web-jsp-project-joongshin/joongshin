				...
				<section class="write-post-container">
					<div class="select-subject-header">
						<div class="subject-header-wrapper">
							...
							<button type="button" onclick="send()" class="h-btn pro-signup-h-btn right-section-item h-btn-primary h-btn-primary2">
								<span>등록</span>
							</button>
						</div>
					</div>
...
<script type="text/javascript">
	const receiveUserId = `${receiveUserId}`;
</script>
<script src="/static/js/message-jym/write-message.js"></script>
</html>