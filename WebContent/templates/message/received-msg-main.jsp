                        ...
                        <div class="col-12">
                            <div class="chat-filter-wrapper">
                                <ul class="chat-filter">
                                    <li class="chat-filter-item" onClick="location.href='msg-main-page.jsp'"> 보낸 채팅 </li>
                                    <li class="chat-filter-item selected" onClick="location.href='received-msg-main.jsp'"> 받은 채팅 </li>
