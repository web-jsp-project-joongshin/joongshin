...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../static/css/message-jym/received-msg.css">
        ...
        <article class="product-provider" id="product-provider">
            <div class="row provider-overview no-gutters">
				...
				<div class="write-button-desktop">
					<div class="dropdown b-dropdown btn-group" id="btn-group">
						<!---->
						<button type="button" id="reply" class="btn dropdown-toggle btn-primary">답장하기</button>
					</div>
				</div>
			</div>
            <!---->
