							...
							<form data-v-668330c4="" data-v-63f85165=""
								...
								<div data-v-668330c4="" role="group" class="input-group">
									...
									<input data-v-668330c4="" type="text"
										...
										class="header" maxlength="" id="__BVID__142">
...
<div id="app-body">
	...
	<div class="swal2-container swal2-center sg-swal swal2-shown"
		...
		<div aria-labelledby="swal2-title" aria-describedby="swal2-content"
			...
			style="width: 320px; display: flex;     border-radius: 20px;">
			...
			<div class="swal2-actions">
				...
				<a href="javascript:history.go(-1)" class="swal2-cancel btn" aria-label=""
