...
public class AdminUserDTO {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + adminPermissionLevel;
	...
	public boolean equals(Object obj) {
		...
		if (adminPermissionLevel != other.adminPermissionLevel)
			return false;
	...
	public String toString() {
		return "AdminUserDTO [userId=" + userId + ", adminPermissionLevel=" + adminPermissionLevel + ", juniorYears="
				+ juniorYears + ", resume=" + resume + ", userEmail=" + userEmail + ", userPassword=" + userPassword
				+ ", username=" + username + ", userAddress=" + userAddress + ", userPhoneumber=" + userPhoneumber
				+ "]";
	}
